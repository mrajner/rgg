...
\begin{document}
  ...
  \subsection*{Listing of \texttt{rgg\_sample\_paper.tex} file
      (source of this document)}
    {\scriptsize\verbatiminput{./\jobname.tex}}

  \subsection*{Listing of \texttt{rgg\_sample\_paper.bib} file 
      (source of bibliography)}
    {\scriptsize\verbatiminput{./\jobname.bib}}
