...
%% the package below ('verbatim') is included
%% in this example only to list
...
\begin{document}
  ...
  \subsection*{Listing of \texttt{rgg.cls} file (journal \LaTeX{} class, \texttt{\rggversion})}
